<?php
$app->post('/api/Dandelion/getTextSimilarity', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken', 'sourceType', 'source1', 'source2']);
    ...
    $query_str = $settings['api_url'] . "datatxt/sim/v1";
    $body = array();
